...
public class SpecialRewardAssignActivity extends AppCompatActivity implements FirebaseDatabaseHelper.OnAssignTaskCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_reward_assign);
        try {
            ...
            Objects.requireNonNull(getSupportActionBar()).setTitle(R.string.special_reward);
                ...
                public void onClick(View v) {
                    ...
                    if (validate(taskModel)) {
                        ...
                        if (mainImageUri == null) {
                            firebaseDatabaseHelper.assignTaskWithoutImage(taskModel, mainImageUri, SpecialRewardAssignActivity.this);

                        } else {
                            firebaseDatabaseHelper.assignTask(taskModel, mainImageUri, SpecialRewardAssignActivity.this);
                        }
                    }
                }
            });
            ivAttachment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (ContextCompat.checkSelfPermission(SpecialRewardAssignActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != getPackageManager().PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(SpecialRewardAssignActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
                            if (ContextCompat.checkSelfPermission(SpecialRewardAssignActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == getPackageManager().PERMISSION_GRANTED) {
...
*/
        ...
        try {
            ...
            db.child("Users").orderByChild("createdBy").equalTo(currentUser.getUid()).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    arrayList1.clear();
                    adapter = new SpinnerrAdapter(SpecialRewardAssignActivity.this, arrayList);
        ...
        if (requestCode == 1) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                CropImage.activity()
                        ...
                        .setAspectRatio(1, 1)
                        .start(SpecialRewardAssignActivity.this);
    ...
    public boolean validate(TaskModel user) {
       /* if (mainImageUri == null) {
        ...
        if (user.getDate().equals("Required points")) {
            etTaskName.setError("Must Fill Field");
            etTaskName.requestFocus();
            return false;
        }
